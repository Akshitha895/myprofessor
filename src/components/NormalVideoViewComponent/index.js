  ...
  onquestionSubmit(time) {
    ...
    if (this.state.questionsarray[this.state.index + 1]) {
      this.setState(
        {
          pausedtime: parseInt(
            this.state.questionsarray[this.state.index + 1].question.timeinsec
          ),
  ...
  onProgress(data) {
    ...
    if (elapsed_sec === this.state.pausedtime) {
      if (this.state.show) {
        ...
        this.setState(
          { isPlaying: true, data: this.state.questiondisplay, show: true },
                ...
                <View style={[styles.absview, { bottom: 25 }]}>
                  <View style={styles.subview}>
                    ...
                    <View style={styles.submiddleview}>
                      <View style={styles.subright}>{timesarray}</View>
                    </View>
